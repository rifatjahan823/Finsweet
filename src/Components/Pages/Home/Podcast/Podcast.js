...
const Podcast = () => {
    return (
            <div className='podcast_section xl:flex  xl:flex-wrap grid grid-cols-1 flex-row justify-evenly items-center mb-32'>
                <div className='xl:basis-1/4 '>
                    <h3 className='text-2xl font-semibold'>Podcast Available On</h3>
                </div>
                <div className='xl:basis-9/12 xl:mt-0 mt-5 '>
